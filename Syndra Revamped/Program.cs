    ...
    internal static class Program
    {
        ...
        private static float GetComboDamage(Obj_AI_Base enemy)
        {
            ...
            if (R.IsReady())
            {
                ...
                var useR = (Config.Item("DontUlt" + enemy.CharData.BaseSkinName) != null
                        && Config.Item("DontUlt" + enemy.CharData.BaseSkinName).GetValue<bool>() == false);
                var okR = Config.Item("okR" + enemy.CharData.BaseSkinName).GetValue<Slider>().Value * .01 + 1;
        ...
        public static float GetComboDamage(Obj_AI_Base enemy, bool UseQ, bool UseW, bool UseE, bool UseR)
        {
            ...
            var damage = 0d;
            var combomana = 0d;
            var useR = Config.Item("DontR" + enemy.CharData.BaseSkinName) != null &&
                       Config.Item("DontR" + enemy.CharData.BaseSkinName).GetValue<bool>() == false;
