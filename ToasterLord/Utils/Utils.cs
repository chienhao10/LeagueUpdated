...
namespace ToasterLord
{
    ...
    class Menu2
    {
        ...
        public static LeagueSharp.SDK.Core.UI.IMenu.Menu CreateMainMenu(string name = "ToasterLord", string displayName = "ToasterLord")
        {
        ...
        public static void CreateGlobalMenuItems(LeagueSharp.SDK.Core.UI.IMenu.Menu menu)
        {
            ...
            AddComponent(ref menu, new LeagueSharp.SDK.Core.UI.IMenu.Menu("ToasterLordGlobalSettings", "Global Settings"));
            GlobalSettings.Menu = (LeagueSharp.SDK.Core.UI.IMenu.Menu)menu["ToasterLordGlobalSettings"];
            AddComponent(ref GlobalSettings.Menu, new LeagueSharp.SDK.Core.UI.IMenu.Values.MenuBool("ToasterLordGlobalSettingsServerChatPingActive", "Server Chat/Ping"));
            AddComponent(ref GlobalSettings.Menu, new LeagueSharp.SDK.Core.UI.IMenu.Values.MenuSlider("ToasterLordGlobalSettingsVoiceVolume", "Voice Volume", 100));
        }
    ...
    {
        public static String File = "C:\\ToasterLord.log";
    ...
    //        if (champion == null)
    //        {
    //            Console.Write("ToasterLord: Can not get champion: " + baseSkinName);
    //            return null;
    //        }
    ...
    //            "ToasterLord", subFolder, name  + ".png"
    //        });
    //        try
    //        {
    ...
    //                    "Assemblies", "cache", "ToasterLord", subFolder));
    ...
    public static class SpriteHelper
    {
        ...
        private static int GetFileSize(String name, String subFolder, bool png = true)
        {
            ...
            {
                Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "LeagueSharp", "Assemblies", "cache",
                "ToasterLord", subFolder, name  + (png ? ".png" : ".jpg")
            });
            try
            {
                byte[] bitmap = File.ReadAllBytes(loc);
    ...
    internal static class Speech
    {
        ...
        public static void Speak(String text)
        {
            ...
            //            Menu.GlobalSettings.GetMenuItem("ToasterLordGlobalSettingsVoiceVolume")
            //                .GetValue<Slider>()
            //                .Value)
            //        {
            //            speech.Value.Volume =
    ...
    internal class Ward
    {
        ...
        {
            var menu = new LeagueSharp.Common.Menu("ToasterLord", "ToasterLordWards", true);
            SetupMenu(menu);
            menu.AddToMainMenu();
        }
        ...
        {
            Language.SetLanguage();
            Wards.Menu = menu.AddSubMenu(new LeagueSharp.Common.Menu("Wards", "ToasterLordWards"));
            Wards.MenuItems.Add(Wards.Menu.AddItem(new MenuItem("ToasterLordWardsActive", Language.GetString("GLOBAL_ACTIVE")).SetValue(false)));
            return Wards;
        }
